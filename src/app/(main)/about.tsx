  ...
  return (
    <Section title="About Me">
      <p className="font-mono text-md md:text-lg xl:text-xl w-[70%] font-light">
        ...
        honours.
        <br />
        I&apos;m particularly drawn to the intersection of practical computing
        and mathematical rigour, especially in areas like compiler design,
        language theory, formal semantics, and most recently machine learning.
